public class Barco implements Transposte{
    ...
    public Float costeTotal(Integer cp) {
        if (cp < 30000) {
            System.out.println("El coste de tu envio en baco es de 10€");
        } else {
            System.out.println("El coste de tu envio en barco es de 15€");
        }
        return null;
    }
